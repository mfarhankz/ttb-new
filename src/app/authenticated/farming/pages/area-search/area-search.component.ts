...
import { AreaSearchFieldComponent } from '@app/authenticated/farming/components/area-search-fields/area-search-field.component';
import { AreaSearchOafAccordionComponent } from '@app/authenticated/farming/components/area-search-fields/oaf-accordion.component';
import { AreaSearchPremierNoteComponent } from '@app/authenticated/farming/components/area-search-fields/area-search-premier-note.component';
import { tabIconClass } from '@app/authenticated/farming/components/area-search-fields/area-search-field.utils';
import { CommonQueriesPanelComponent } from '@app/authenticated/farming/components/area-search-panels/common-queries-panel.component';
import { RecentQueriesPanelComponent } from '@app/authenticated/farming/components/area-search-panels/recent-queries-panel.component';
import { PREMIUM_FIELD_GROUP_IDS, AREA_SEARCH_DEFAULT_MAX_LIMIT } from '@app/authenticated/farming/config/area-search-fields.config';
...
import { AreaSearchAccordionStateService } from '@app/authenticated/farming/services/area-search-accordion-state.service';
