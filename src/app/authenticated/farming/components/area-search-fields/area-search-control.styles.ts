...
export const AreaSearchControlStyles = {
  ...
  treeMultiSelect: [
    ...
    '[&_.p-multiselect-chip-item]:flex [&_.p-multiselect-chip-item]:shrink-0 [&_.p-multiselect-chip-item]:items-center',
    '[&_.p-multiselect-chip]:flex [&_.p-multiselect-chip]:h-6 [&_.p-multiselect-chip]:items-center [&_.p-multiselect-chip]:gap-1',
    '[&_.p-multiselect-chip]:rounded-md [&_.p-multiselect-chip]:border [&_.p-multiselect-chip]:border-border',
    '[&_.p-multiselect-chip]:bg-surface [&_.p-multiselect-chip]:px-1.5 [&_.p-multiselect-chip]:py-0',
    '[&_.p-multiselect-chip]:text-caption [&_.p-multiselect-chip]:text-foreground',
