...
import {
  ...
  SendDataRequest,
  ShareQueryRequest
} from '@app/core/interfaces/area-search-query.interface';
import {
  GlobalSearchCountData,
  GlobalSearchResponseData,
  TtbGlobalSearchCountResponse,
  TtbGlobalSearchResponse
} from '@app/core/interfaces/global-search-response.interface';
import { SavedSearchRecord, TtbSavedQueriesResponse } from '@app/core/interfaces/saved-search.interface';
