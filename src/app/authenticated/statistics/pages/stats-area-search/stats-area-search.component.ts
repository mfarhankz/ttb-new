...
} from '@app/authenticated/statistics/config/statistics.config';
...
import { StatsAreaSearchService } from '@app/authenticated/statistics/services/stats-area-search.service';
