...
} from '@app/authenticated/detail/config/detail-page-toolbar.config';
import {
  buildQueryOverflowMenuItems,
  buildQuerySaveShareMenuItems,
  QueryOverflowActionId,
  QuerySaveShareActionId
} from '@app/authenticated/detail/config/detail-page-query-toolbar.config';
...
import { MapTablePipelineComponent } from '@app/authenticated/map/components/map-table-pipeline/map-table-pipeline.component';
...
import { DetailPageService } from '@app/authenticated/detail/services/detail-page.service';
import { LayoutService } from '@app/core/services/layout.service';
import { MapTableSyncService } from '@app/authenticated/map/services/map-table-sync.service';
...
import type { DetailSource } from '@app/authenticated/farming/services/clear-search-state.service';
import { AuthService } from '@app/core/services/auth.service';
import { NetSheetModalService } from '@app/authenticated/net-sheet/services/net-sheet-modal.service';
