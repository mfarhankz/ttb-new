...
import { resolveAdminUserRowActions } from '@app/authenticated/admin/config/admin-user-actions.config';
...
} from '@app/core/config/user-type-labels.config';
import {
  AdminUserNameCol,
  ...
  AdminUserTableBadge,
  AdminUserUserCol
} from '@app/core/interfaces/admin-users.interface';
