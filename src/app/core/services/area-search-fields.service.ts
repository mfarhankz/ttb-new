...
import { TtbSearchFieldsResponse } from '../interfaces/global-search-response.interface';
import {
  normalizeChoiceFieldMeta,
  normalizeChoiceTreeFieldMeta,
  normalizeExactMatchFieldMeta,
  normalizeFieldValidation
} from '../utils/area-search-field-meta.util';
import { repairTruncatedLegacyJson } from '../utils/ttb-response.util';
