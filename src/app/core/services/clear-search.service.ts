...
import { AreaSearchFormService } from './area-search-form.service';
...
import { ClearSearchContext, ClearSearchStateService } from './clear-search-state.service';
import { StatisticsSessionService } from './statistics-session.service';
import { StatsAreaSearchStateService } from './stats-area-search-state.service';
