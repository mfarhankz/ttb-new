...
export const API_CONFIG = {
  ...
  endpoints: {
    ...
    getNetsheet: '/get_netsheet.json',
    getNetsheetVariableFees: '/get_netsheet_variable_fees.json',
    saveNetsheet: '/save_netsheet.json',
    saveNetsheetSettings: '/save_netsheet_settings.json',
    deleteNetsheet: '/delete_netsheet.json',
    getNetsheetPdf: '/get_netsheet.pdf',
    ...
    saveQueryForDla: '/save_query_for_dla.json',
    getDlaHistory: '/get_dla_history.json',
    createNewProfile: '/create_new_profile.json',
