...
import { resolveStatisticsTractRowActions } from '../config/detail-statistics-actions.config';
...
import { TractRecord } from '../interfaces/statistics.interface';
import { SavedFarmGeometry } from '../interfaces/saved-farm.interface';
import { StatisticsSessionService } from '../services/statistics-session.service';
