...
import {
  ...
  PropertyRecordRaw
} from '../interfaces/property-record.interface';
import { SavedFarmGeometry, SavedFarmRecord } from '../interfaces/saved-farm.interface';
...
const SUPPORTED_DETAIL_SOURCES = new Set(['farm', 'search']);
