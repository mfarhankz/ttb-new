...
export const AreaSearchControlStyles = {
  ...
  premierNoteAccordion: [
    ...
    '**:[[class*="accordioncontent-content-wrapper"]]:bg-[#fcf8e3]!',
    '**:[[class*="accordioncontent-content"]]:bg-[#fcf8e3]!',
    '**:[[class*="accordioncontent-content"]]:p-0!',
    '**:[[class*="accordioncontent-content"]]:text-[#8a6d3b]!',
  ...
  dangerNoteAccordion: [
    ...
    '[&_.p-accordioncontent:not([data-p-active="true"])]:m-0!',
    '[&_.p-accordioncontent:not([data-p-active="true"])_.p-motion]:hidden!',
    '**:[[class*="accordioncontent-content-wrapper"]]:bg-[#f2dede]!',
    '**:[[class*="accordioncontent-content"]]:bg-[#f2dede]!',
    '**:[[class*="accordioncontent-content"]]:p-0!',
    '**:[[class*="accordioncontent-content"]]:text-[#a94442]!',
    '**:[[class*="accordioncontent-content"]]:shadow-none!'
  ].join(' ')
} as const;
