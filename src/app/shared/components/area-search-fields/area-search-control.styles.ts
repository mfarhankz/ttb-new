...
export const AreaSearchControlStyles = {
  ...
  treeMultiSelect: [
    ...
    '[&_.p-multiselect-label-container]:flex-nowrap [&_.p-multiselect-label-container]:items-center',
    '[&_.p-multiselect-label-container]:gap-1 [&_.p-multiselect-label-container]:overflow-hidden',
    '[&_.p-multiselect-label-container]:py-0 [&_.p-multiselect-label-container]:pl-2',
    '[&_.p-multiselect-label]:flex [&_.p-multiselect-label]:h-full [&_.p-multiselect-label]:min-w-0',
    '[&_.p-multiselect-label]:flex-nowrap [&_.p-multiselect-label]:items-center [&_.p-multiselect-label]:gap-1',
    '[&_.p-multiselect-label]:overflow-hidden',
