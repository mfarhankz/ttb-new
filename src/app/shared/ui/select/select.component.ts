...
export class SelectComponent implements ControlValueAccessor {
  ...
  getSelectClasses(): string {
    const baseClasses = 'block w-full rounded-md border shadow-xs transition-colors focus:outline-hidden focus:ring-2 focus:ring-offset-0 appearance-none bg-surface text-foreground';
