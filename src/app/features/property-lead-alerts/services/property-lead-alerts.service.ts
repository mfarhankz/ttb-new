...
import { PLA_SUBSCRIPTION_PLAN } from '@app/features/property-lead-alerts/config/property-lead-alerts.config';
import {
  PlaHistoryRecord,
  PlaSaveQueryRequest,
  TtbPlaHistoryResponse,
  TtbPlaSaveQueryResponse
} from '@app/features/property-lead-alerts/interfaces/property-lead-alerts.interface';
