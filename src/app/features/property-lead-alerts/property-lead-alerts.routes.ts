...
export const propertyLeadAlertsRoutes: Routes = [
  {
    ...
    loadComponent: () =>
      import('@app/features/property-lead-alerts/pages/property-lead-alerts.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('@app/features/property-lead-alerts/pages/property-lead-alerts-history.component').then(
